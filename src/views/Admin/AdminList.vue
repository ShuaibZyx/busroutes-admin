<template>
  <div class="adminList" v-if="$route.path === '/admin'">
    <div class="operation">
    ...
    <el-table :data="adminList" fit border stripe :highlight-current-row="true">
      ...
      <el-table-column label="操作" align="center">
        <template slot-scope="scope">
          ...
          <el-button
            ...
            @click="resetAdminPassword(scope.row.adminId)"
            >重置密码</el-button
          >
          <el-popconfirm
