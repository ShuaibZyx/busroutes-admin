<template>
  <el-card shadow="never">
    <div slot="header" class="cardHeader">
      <el-page-header @back="$router.back()" content="更新公告" />
    </div>
    <div class="editNotice">
      <div class="common">
        ...
        <div class="btns">
          <el-button type="info" size="small" @click="resetNotice">
            重置
          </el-button>
  ...
  methods: {
    ...
    editNotice() {
      this.$refs.form.validate(async (valid) => {
        ...
        const { data: editNoticeRes } = await this.$axios.post(
          "notice/modify",
          this.notice
        );
        this.resetNotice();
        this.$message({
          message: editNoticeRes.msg,
          type: `${editNoticeRes.code !== 200 ? "error" : "success"}`,
          center: true,
        });
      });
    },
